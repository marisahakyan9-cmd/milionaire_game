...
helpFifty.addEventListener('click', function removeTwoBlocks() {
  helpSound.play()
  let blockActiveQusetion = getActiveBlockQusetion()
  let numRandom = Math.floor(Math.random() * blockActiveQusetion.children[1].children.length)
  let blockChildrenAnswer = blockActiveQusetion.children[1].children
  let nameQusetion = blockActiveQusetion.classList[1]
  let blockCorrectAnswer = getBlockAnswer(blockChildrenAnswer, nameQusetion)
